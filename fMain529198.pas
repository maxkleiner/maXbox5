 { ****************************************************************
  ...
  classes :	      see ModelMaker ps#12           f
  ...
  revisions :     20.07.04 build menu structure
    ...
    locs=1974    V3.0 pop3, png, smtp, exceptionlog, emails, RegEX, sysutils
         ...
         11230          build 4.2.5.10 atom edit and 6 units more  hugeword RSA
          ...
          13325   5.2.9.185 III July 2025 fix bug in colorgrid  - minesweeper5X, itemheights, mX5 Chess engine, getjpegfromresname()
          13340   5.2.9.190 IV July 2025 othelloboardSource  - ImageAscii, mX5 Chess engine2 mp3stream, DigiBox()
          13360   5.2.9.195 V July 2025 weatherreport5.3 - ImageList SetSize, DigiBox2() - simpleDOM2  -runcommandinmemo -Pas2HTMl Doc Processor
          13365   5.2.9.196 August 2025 version check -wgetenvironmentinfos --TProcess3 reengineering findcomponent3,findcontrol3, GR32 Libs, DLLImp3
          13490   5.2.9.198 September 2025 version check -edgeview resultback --TProcess3 reengineering-geomapview3 update-syndwrite synedit UPgrade foldingdemo, sysinfo
...
uses
  ...
  System.ImageList, syneditkeycmds, Vcl.Imaging.pngimage //, fmain_47650 ,529198
...
type
  ...
  Tmaxform1 = class(TForm)
    ...
    PSScript1: TPSScript;
    GoGame51: TMenuItem;
    Minesweeper51: TMenuItem;
    Pas2DocProcessor1: TMenuItem;
    PrintStudio51: TMenuItem;
    SystemInfo1: TMenuItem;      //SynEdit1
    ...
    procedure Minesweeper51Click(Sender: TObject);
    procedure Pas2DocProcessor1Click(Sender: TObject);
    procedure PrintStudio51Click(Sender: TObject);
...
uses
  ...
  uPSC_controls_orig,   //tcontrol & twincontrol thackclass  - Tmouseevent -imagelist
  //uPSC_classes,
  //uPSR_classes,
  uPSComponentExt,
  uPSR_graphics,
 ...
 uPSI_DBGrids,  //3.5.1   local fork of vcl.dbgrids
  ...
  uPSI_DBCGrids,   //*)
  uPSI_Provider,
  uPSI_ImgList,         //Timagelist custom imagelist -Image21:= TImage.create(fmain)
  uPSI_Clipbrd,  //*)
  uPSI_MPlayer,
...
//  uPSI_StrUtils,    move  down
 ...
 uPSI_JvgXMLSerializer,
  ...
  uPSI_RegularExpressions,  //delphi standard ones based on perlregex
  uPSI_SynURIOpener,
 ...
 // uPSI_HttpRESTConnectionIndy,
  ...
  uPSI_devExec,
  ProcessListFrm,
  dprocess3,         //as TProcess2  --> now as TProcess3 +process_win.inc
  uPSI_dpipes,           //inputpipestream3    writestring()
  uPSI_dprocess3,       //parameters2 valid chaine
  //uPSI_cDictionaries,
  uPSI_oysUtils,
  tetris1,
  usniffer,
 ...
 (* uPSI_IdCookie,   *)
  ...
  uPSI_IdTCPConnection, //3.1  readln, writeln via IOHandler
  IFSI_IdTCPClient,  //*)
...
(*  uPSI_dbTree,      //properties     *)
 ...
 uPSI_JvPickDate,
  ...
  OthelloBoard,                //bad unit format fixed
  uPSI_OthelloBoard,           // othello board and movelist
  othellomain,                 //5.2.9.185
  uPSI_othelloMain,
  uPSI_SimpleDOM,
  uPSI_NamedPipes,
  uPSI_NamedPipeServer, //*)
  uPSI_process,               //TProcess.create     unit process /restunitsREST
  uPSI_DPUtils,
  uPSI_CommonTools,
  uPSI_DataSendToWeb,
  uPSI_StarCalc,
...
//  uPSI_SockHTTP,
 ...
 (* uPSI_SockAppNotify,  *)
  ...
  //uPSI_xercesxmldom,
  uPSI_xmldom, //*)
  uPSI_JclExprEval, //*)    CL.AddTypeS('TFloat', 'Double');
  uPSI_Gameboard, //*)
  uPSI_ExtPascal,
  uPSI_ExtUtil,
  uPSI_FCGIApp,  //*)
  ...
  uPSI_ChessBrd,
  uPSI_ChessPrg,
  imageasciiMain, //last app for forms demo
  uPSI_Pas2Html,     //coddoc doc processor needs Delphi Parse
  uPSI_Graph3D, //*)
  uPSI_SysInfoCtrls,
  uPSI_RegUtils,  //*)
 ...
 uPSI_ALIsapiHTTP,         //4.7.1.80
  ...
  uPSI_cWindows,              //playreswav playresmp3
  ...
  uPSI_TAChartUtils,  // *)
   //Python Section
  uPSI_PythonEngine,        //change to 1.12  plus CheckRegistry
  uPSI_VclPythonGUIInputOutput,
  uPSI_VarPyth,
  uPSI_PyCommon,     //pyengine + pyenvironment +pyexceptions
  uPSI_cParameters,  //uPSI_cFileTemplates, *)
  uPSI_uCommonFunctions,        //5.02.40   fromo pyscripter
  uPSI_uCommonFunctions2,       //5.2.9.198
  uPSI_WDCCMisc,
  ...
  uPSI_IdNNTPServer,        //4.2.4.25  *)  - 5.2.9.196
  uPSI_UWANTUtils,
...
//  uPSI_IdSSLOpenSSL,     //3.9.4    *)
  ...
  uPSI_Midas,                 //V4
  U_go3,                      //GoGame  V5.2
  uPSI_U_Go3,              //UnifyNameValues - ConvertPngToJpeg . imagelisttobmp
  DocProcMainUnit,         //pas2htm doc processor
  //eLibTAGExtractor,
  PJSysInfo,
  FmDemo,             //for sysdemo systeminformation
  uPSI_ConvUtils,
  uPSI_DBClient,   //
  uPSI_CDSUtil,
  uPSI_GraphUtil, //3.7
...
// uPSI_JvSQLS,
 ...
 // SynEditMarkupHighAll,  //3.9.8.9 beta   *)
  ...
  uMainsweeper,  //5.2.9.185 mainsweeper 5X spain version
  uPSI_uMainsweeper,
  uPSI_DigiBox,
  foldingdemounit1,
  MTestPP,         //synedit printdemo   printstudio3
 // uPSI_DBXChannel,
  //uPSI_DBXIndyChannel, *)
  VCLScannerIntf,
...
{const
  ...
  eoTabsToSpaces, eoSmartTabDelete];    }    //check SYNEDIT_DEFAULT_OPTIONS

 //note: eodropfile is false cause of  procedure Tmaxform1.WMDROP_THEFILES
 const
 SYNEDIT_DEFAULT_OPTIONS = //[eoAltSetsColumnMode,  replace by multicaret
    [eoAutoIndent, eoDragDropEditing, eoKeepCaretX, eoSmartTabs,
 ...
 SYNEDIT_DEFAULT_SCROLLOPTIONS =
    [eoHideShowScrollbars, eoDisableScrollArrows, eoShowScrollHint, eoScrollPastEol];
...
(*  SIRegister_JvDBUtil(X);  *)
 ...
 (* SIRegister_JvBdeUtils(X);   *)
  ...
  SIRegister_Contnrs(X);   //5.2.9. moved up
  SIRegister_StBase(X);     //*)
...
(*  SIRegister_EncdDecd(X);
  ...
  SIRegister_uMainsweeper(X);
  SIRegister_OthelloBoard(X);
  SIRegister_othelloMain(X);
  SIRegister_DigiBox(X); //5.2.9.190
  SIRegister_SimpleDOM(X);   //5.2.9.195
...
//  SIRegister_Contnrs(X);          5.2.9.  move upwards
...
(*  SIRegister_JvMemTable(X);   *)
 ...
 SIRegister_CppTokenizer(X);
  ...
  SIRegister_GR32_LowLevel(X); //*)  529196
...
(* SIRegister_IdSMTP(X);
 ...
 (* SIRegister_JclPrint(X); *)
  ...
  SIRegister_umath(X); //*)
  SIRegister_ufft(X);
  SIRegister_GR32_System(X);  //*)        529196
 ...
 (* SIRegister_ALSMTPClient(X);
  ...
  //SIRegister_process(X);       //move upward  not : 3715
...
SIRegister_cyDocER(X);
 ...
 SIRegister_pipes(X); //*)
 SIRegister_process(X);      //TProcess-Delphi
...
(* SIRegister_PJIStreams(X); *)
 ...
 SIRegister_uCommonFunctions2(X);      //5.2.9.198
...
(* SIRegister_W32VersionInfo(X);  *)
 ...
 //RIRegister_uCommonFunctions_Routines(Exec);    later
...
(*  SIRegister_gnugettext(X);    *)
 ...
 SIRegister_umaxPipes(X);
  ...
  SIRegister_IdNNTPServer(X); //*)  529196
...
(*  RIRegister_IdHostnameServer(X);   *)
 ...
 RIRegister_oysUtils(X);
  ...
  RIRegister_GR32_LowLevel_Routines(Exec); //*)  529196
...
(*   {$IFDEF CD2XXUNIT}
 ...
 RIRegister_UConsoleAppEx(X);     //3.99.80
  ...
  RIRegister_uMainsweeper(X);
  RIRegister_OthelloBoard(X);
  RIRegister_OthelloBoard_Routines(Exec);  //V5.2.9.190
  RIRegister_othelloMain(X);
  RIRegister_DigiBox(X);
  RIRegister_DigiBox_Routines(Exec);    //V5.2.9.190
  RIRegister_SimpleDOM(X);
...
RIRegister_DSUtil_Routines(Exec);
 ...
 (* RIRegister_PJIStreams(X);     *)
  ...
  RIRegister_uCommonFunctions2_Routines(Exec);
 RIRegister_TXStringList(X);       //fix TEncoding to ANSI  5.2.9.198
...
(* RIRegister_SvrHTTPIndy(X);
 ...
 // RIRegister_NSToIS_Routines(Exec);
  ...
  RIRegister_Pas2Html_Routines(Exec);      //V529195
 ...
 RIRegister_NamedPipeThreads(X);
  ...
  RIRegister_IdNNTPServer(X);  //*)   529169
...
//var //Plugin: TPSPlugin;  //var    amark: TSynEditMark;
  var lm: integer;  m: string;   T0: int64;
  myscannotation: TSynScrollbarAnnotations;  myscitem:TSynScrollbarAnnItem;
begin
  //application.MessageBox('This should be on topsyndwrite2formcreatee.', 'Look', MB_OK);
  self.Height:= 830;
  self.Width:= 950;
  STATEdchanged:= false;
  ...
  memo1.Options:= SYNEDIT_DEFAULT_OPTIONS; //DefSynEditOptions;   local scope!
  memo1.scrollOptions:= SYNEDIT_DEFAULT_SCROLLOPTIONS; //DefSynEditOptions;
 ...
 //  procedure StartFoldRange(ALine : Integer; AFoldType : integer; AIndent : Integer = -1);
  // memo1.Highlighter.GetFriendlyLanguageName
  //SynPasSyn1.
  ...
  // memo1.onchange:= Nil;
 //memo1.ScrollbarAnnotations:= memo1.SetDefaultAnnotations;
 //memo1.scrollbarannotations.Add;
  //memo1.ScrollbarAnnotations.SetDefaultAnnotations;
  //memo1.UseAnnotatedScrollbar := True;
  //memo1.ScrollbarAnnotations.update
  //memo1.ScrollbarAnnotations.assign(memo1.gutter);
  //memo1.gutter.assign(memo1.ScrollbarAnnotations);
  //memo1.ScrollbarAnnotations.count:= 3;
  memo1.ScrollBars:= ssboth;
  //memo1.IndentGuides.Style:= igsDotted;
  memo1.Gutter.TrackChanges.Width:= 2;      //ex 3
  memo1.Gutter.TrackChanges.Visible:= True;
  //myscitem:= TSynScrollbarAnnItem.Create(nil);    //TCollection
  //myscannotation:=
    //7 TSynScrollbarAnnotations.Create(maxform1,
      //  TCollectionitemclass(TSynScrollbarAnnItem.Create(nil)));
  myscannotation:= TSynScrollbarAnnotations.Create(memo1, TSynScrollbarAnnItem);
  myscannotation.SetDefaultAnnotations;
  memo2.Lines.Add('Default ScrollbarAnnotations.count: '+inttostr(memo1.ScrollbarAnnotations.count));

 {  with myscannotation.Add as TSynScrollbarAnnItem do
  begin
    AnnPos := sbpFullWidth;  AnnType := sbaCarets;
  end;
  with myscannotation.Add as TSynScrollbarAnnItem do
  begin
    AnnPos := sbpLeft; AnnType := sbaBookmark;  FullRow := True;
  end;
  with myscannotation.Add as TSynScrollbarAnnItem do
  begin
    AnnPos := sbpRight; AnnType := sbaTrackChanges;  FullRow := True;
  end;  }
  // memo1.gutter.autosize:= true;
   memo1.ScrollbarAnnotations:= myscannotation;
  memo1.ScrollbarAnnotations:= memo1.ScrollbarAnnotations;
  //memo1.ScrollbarAnnotations.ongetinfo()
  //https://github.com/pyscripter/SynEdit/issues/103
  //memo1.ScrollBarAnnotations:= TSynScrollbarAnnItem([sbaCarets, sbaBookmark, sbaTrackChanges {sbaError}]);
  //memo1.scrollbarannotations.Add;
  //memo1.ScrollbarAnnotations.Annotations[1];
  //memo1.gutter.AssignableBands:= true;
  ...
  bookmarkimage:= 12;
  memo1.BookMarkOptions.BookmarkImages:= Nil;
  memo1.SetBookmark(0,3,memo1.CaretY);     //init
  {memo1.BookMarkOptions.BookmarkImages:= imagelist3;
  memo1.SetBookmark(4,0,memo1.CaretY);
  memo1.BookMarkOptions.BookmarkImages:= Nil;  }
  ...
  if STATExceptionLog then begin
   ...
   maxform1.Caption:= 'maXbox52 Ocean1210 mX529 XXIVRheingold+++++ beta920!';
         ...
         if not PSScript.Compile then begin
           ...
           //  NativeWriteLn(act_Filestring);
              for lm:= 0 to PSScript.CompilerMessageCount - 1 do begin
                ...
                NativeWriteln('mX5Shell: '+PSScript.CompilerErrorToStr(lm)+#13#10 +m);
            end;
           end;
...
begin
 ...
 // GetLocaleFormatSettings(LOCALE_SYSTEM_DEFAULT, formatSettings);
  ...
  statusbar1.panels.items[0].width:= maxform1.width-270;
  //memo2.Lines.Add('ScrollbarAnnotations.count activate: '+inttostr(memo1.ScrollbarAnnotations.count));
  //memo2.Lines.Add('ScrollbarAnnot: '+inttostr(ord(memo1.ScrollbarAnnotations.Annotations[1].AnnType)));
...
// how to add functions into the ps-engine:
{procedure TPSPascalCompiler.DefineStandardProcedures;
 ...
 function DefProc(Caller: TPSExec; p: TPSExternalProcRec; Global, Stack:
  ...
  optional: cs.OnExternalProc := DllExternalProc;
 }
...
begin
 ...
 Sender.AddFunction(@GetASCII,'Function GetASCII: string)');
  ...
  Sender.AddFunction(@FindComponent3,'function FindComponent3(vlabel: string; aowner: Tcomponent): TComponent;');
  Sender.AddFunction(@FindControl3,'function FindControl3(const AName: string; aowner: TComponent; aparent: TWinControl): TComponent;');
  ...
  begin
    ...
    if b then begin
       ...
       with ledimage do begin
        ...
        memo1.SetBookmark(0,4,memo1.CaretY);
  ...
  maxForm1.Caption:= 'maXbox5 64-bit ScriptStudio🎧  '+ExtractFilename(Act_Filename);
   ...
   memo2.Lines.Add('compiled: '+inttoStr(memo1.LinesInWindow));
    ...
    if not PSScript.Execute then begin
      ...
      memo1.SetBookmark(0,3,memo1.caretY);
    end else begin
    stopw.Stop;
...
begin
   ...
   //  application.MessageBox('This should be on dragdrop.', 'Look', MB_OK);
   end;
...
begin
  ...
  //showmessage('Updater at V3.5, now go to: www.softwareschule.ch/maxbox.htm');
   memo2.lines.Add(' Actual Version is: '+VersionCheckAct);    //wininet
   memo2.lines.Add(' Web Checked Version: '+checkBox);
end;
...
begin
  ShowMessage('Add On available in V5.3')
end;
...
procedure Tmaxform1.Minesweeper51Click(Sender: TObject);
begin
  //minseweeper  51
  // ShowMessage('Add On available in V5.2 - start now with OK, script: 1419_minesweeper5.TXT');
  //minesweeper game 5
  Application.CreateForm(TFMainsweeper, FMainsweeper);
  FMainsweeper.Show;
  //minesweeper game 52
...
begin
 ...
 if showInclude1.Checked then begin STATInclude:= true;
   memo1.CodeFolding.ShowCollapsedLine:= true
 end else begin
    STATInclude:= false;
    memo1.CodeFolding.ShowCollapsedLine:= false;
 end;
...
begin
 ...
 if showSpecChars1.Checked then Memo1.visiblespecialchars:=
                              Memo1.visiblespecialchars +[scControlChars,scWhitespace,scEOL] else
 Memo1.visiblespecialchars:= Memo1.visiblespecialchars - [scControlChars,scWhitespace,scEOL];
...
procedure Tmaxform1.PrintStudio51Click(Sender: TObject);
begin
  Application.CreateForm(TForm1print, Form1print);      //Form1: TForm1;
   //Application.CreateForm(TmidiForm1, midiForm1);
  Form1print.Show;
end;
...
begin
 with memo1 do begin
  ...
  Options:= SYNEDIT_DEFAULT_OPTIONS; //DefSynEditOptions;
  Highlighter:= SynPasSyn1;
...
begin
  fconvMain:= TfconvMain.Create(self);       //synedit
  try
    fconvMain.ShowModal;
  finally
    fconvMain.Free;
    ...
    if FileExists(Act_Filename) then begin
      ...
      with debugout do begin
       ...
       output.Lines.add('File Size: '+IntToStr(FileSizeByName(Act_Filename))+' Kb');
        ...
        output.Lines.add('mX5 Internet Version: '+checkBox); // ActVersion);
...
begin
  Application.CreateForm(TSysDemoForm, SysDemoForm);
   SysDemoForm.Show;
...
begin
   ...
   Application.CreateForm(TimgasciiMainForm, imgasciiMainForm);
   imgasciiMainForm.Show;
   memo2.Lines.Add('TimgasciiMainForm MainForm Loaded');
end;
...
begin
 { CaptureScreenPNG(ExePath+'mx5_screenshot.png');
  ...
  // from png to jpg from 5.0. to 5.2
  TakeScreenshot(ExePath+'mx52_screenshot.jpg');
  memo2.Lines.Add('Screenshot saved as: '+ExePath+'mx52_screenshot.jpg');
  searchAndOpenDoc(ExtractFilePath(ParamStr(0))+'mx52_screenshot.jpg');
...
begin
 Application.CreateForm(TfoldingdemoForm1, foldingform1);      //Form1: TForm1;
  //Form2clavier.Show;
   //Application.CreateForm(TmidiForm1, midiForm1);
  foldingform1.Show;
...
procedure Tmaxform1.Pas2DocProcessor1Click(Sender: TObject);
begin
  // pas to docprocesspr
  Application.CreateForm(TDocProcMainForm,DocProcMainForm);
  DocProcMainForm.Show;
 end;
...
begin
  ...
  // memo1.SetBookmark(3,memo1.caretx,memo1.carety);
  statusBar1.panels[2].text:= ' M!'+' T:'+intToStr(numprocessthreads);
  memo1.Gutter.BorderColor:= clwebyellow;  //clweblightyellow;
  //memo1.ScrollbarAnnotations.annotations[1].GetInfo(TArray[memo1.carety],TArray[clred]);
  //memo2.Lines.Add('namepath '+memo1.ScrollbarAnnotations.GetNamePath);
  //memo2.Lines.Add('ScrollbarAnnotations.count: '+inttostr(memo1.ScrollbarAnnotations.count));
end;
...
begin
  ...
  if NOT foundbm then begin
   ...
   //memo1.SetBookMark(mark.BookmarkNumber+1, 0, 1);  //aline
   memo1.SetBookMark(mark.BookmarkNumber+1, 0, 2);
   memo1.SetBookMark(mark.BookmarkNumber+2, 0, 3);
 end;
end;
...
procedure Tmaxform1.SystemInfo1Click(Sender: TObject);
begin
  Application.CreateForm(TSysDemoForm, SysDemoForm);
   SysDemoForm.Show;
end;
...
begin
 ...
 {mform:= TmForm.Create(self);
  ...
  Application.CreateForm(TothelloMainForm, othelloMainForm);
   othelloMainForm.Show;
   memo2.Lines.Add('TOthello MainForm Game Loaded');
 end;
...
begin
 ...
 //https://github.com/maxkleiner/maXbox5/
 //https://github.com/graphics32/graphics32/blob/master/DocProcessor/Pas2Html.pas
 //https://dev.to/max_kleiner_9d12e786b3ecc/mp3-stream-shell-1cod
 //https://github.com/remobjects/pascalscript/blob/master/Source/uPSC_dll.pas
 // //application.MessageBox('This should be on topsyndwrite1.', 'Look', MB_OK);
