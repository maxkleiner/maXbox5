...
as an OpenToolsAPI to modify the maXbox GUI - V3.5 -V3.8.6 , version check
  ...
  //locs V5.0.2.28 = 3815  locs V5.0.2.80 = 3821  3825  V50360   3827   V50470  3837- V51470 V51480  V51498 - 3856  - 51698 XVIII-XIX  - 517120 -529180 -3865 529195
...
begin
  ...
  //with CL.AddClassN(CL.FindClass('TMaxForm1'),'MaxForm1') do begin
   CL.AddClassN(CL.FindClass('TCustomControl'),'TCustomSynEdit');
   CL.AddClassN(CL.FindClass('TCustomSynEdit'),'TSynEdit');
   CL.AddClassN(CL.FindClass('TSynEdit'),'TSynMemo');
   CL.AddClassN(CL.FindClass('TForm'),'TMaxForm1');

  with CL.AddClassN(CL.FindClass('TForm'),'TMaxForm1') do begin
    RegisterProperty('memo2', 'TMemo', iptrw);
    RegisterProperty('memo1', 'TSynEdit', iptrw);
   ...
   //V3.9
    ...
    RegisterMethod('procedure JumptoOutput1Click(Sender: TObject);');
     ...
     RegisterMethod('procedure midikeyClick(Sender: TObject);');
      ...
      RegisterMethod('procedure Minesweeper51Click(Sender: TObject);');
      RegisterMethod('procedure Pas2DocProcessor1Click(Sender: TObject);');
...
begin
 ...
 CL.AddConstantN('MBVERSION','String').SetString('5.2.9.195');
 CL.AddConstantN('VERSION','String').SetString('5.2.9.195');
 CL.AddConstantN('MBVERIALL','Integer').SetInt(529195);
 CL.AddConstantN('MBVER2','String').SetString('529195');
...
(*----------------------------------------------------------------------------*)
procedure TMaxForm1memo1_W(Self: TMaxForm1; const T: TSynEdit);
Begin Self.memo1 := T; end;

(*----------------------------------------------------------------------------*)
procedure TMaxForm1memo1_R(Self: TMaxForm1; var T: TSynEdit);
   ...
   // RegisterPropertyHelper(@TMaxForm1PSImport_ComObj1_R,@TMaxForm1PSImport_ComObj1_W,'PSImport_ComObj1');
    ...
    RegisterMethod(@TMaxForm1.Darkcolor1Click, 'Darkcode');
     ...
     RegisterMethod(@Tmaxform1.go5click, 'GoGameClick');
      RegisterMethod(@Tmaxform1.Minesweeper51Click, 'Minesweeper51Click');
      RegisterMethod(@Tmaxform1.Pas2DocProcessor1Click, 'Pas2DocProcessor1Click');
