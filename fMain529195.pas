...
type
  ...
  Tmaxform1 = class(TForm)
    ...
    Pas2DocProcessor1: TMenuItem;      //SynEdit1
...
//  uPSI_IdSSLOpenSSL,     //3.9.4    *)
  ...
  uPSI_Midas,                 //V4
  U_go3,                      //GoGame  V5.2
  uPSI_U_Go3,              //UnifyNameValues - ConvertPngToJpeg
...
begin
  ...
  if STATExceptionLog then begin
   ...
   maxform1.Caption:= 'maXbox52 Ocean1190 mX529 XXIIRheingold+++++ beta680!';
